...
python3 ./src/data/dataset_tool_mi.py --dataset Pelvis_2.1 --configuration_file ./configs/pelvis_preprocessing.yaml --data_dir /home/lorenzo/data_m2/data/interim/Pelvis_2.1/nifti_volumes_256x256_normalized --interim_dir /home/lorenzo/data_m2/data/interim --reports_dir ./reports/ --resolution 256 --pop_range 10 --transpose_img True --processing_step snap_pickle
sleep3m
