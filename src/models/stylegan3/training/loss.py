...
class StyleGAN2Loss(Loss):
    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, gain, cur_nimg): # cur_nimg define how many images are passed at the current step through the network
